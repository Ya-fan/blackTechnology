    ...
    <form action="" method="post" class="form form-horizontal" id='form' enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                    <input type="checkbox" name="is_show" id="is_show" value="1" checked>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="site_url" id="site_url" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="brand_desc" cols="" id="brand_desc" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
...
<script type="text/javascript">
    ...
    function picture_colume_add(obj){
        ...
        $.ajax({
                type:"post",
                url:"<?= UrlService::buildWwwUrl('/admin/brand/file')?>",
                processData:false,
                contentType:false,
                data:form,
                dataType:"json",
                success:function(data){
                    $("#logo").after("<img src='"+data+"' width='150' id='pic'/>");
                }
            })
    }
    ...
    //表单验证
        ...
        $("#submit").click(function(){
            ...
            if(check.check_name && check.check_desc && check.check_sort && check.check_url){
                ...
                $.ajax({
                    type:"post",
                    url:"<?= UrlService::buildWwwUrl('/admin/brand/add')?>",
                    data:{
