...
<title><?=  \Yii::$app->params['title']['name']; ?></title>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:void(0)"><?= \Yii::$app->params['title']['name']; ?></a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="javascript:void(0)"></a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">I Can do all things... </span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a href="<?= UrlService::buildAdminUrl( '/user/list' ) ?>" title="管理员列表">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
